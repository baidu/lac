...
注意：python 版本的 LAC 已经迁移 [PaddleNLP/lexical_analysis](https://github.com/PaddlePaddle/models/tree/develop/PaddleNLP/lexical_analysis)，本项目将不再维护。如果您仅仅关注 C++ 版本的词法分词，本项目仍有参考价值。
