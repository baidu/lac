...
## 版本更新
我们在最近对LAC进行了一次版本更新，更新内容包括：
- **LAC**：词性标注模型粒度更新为字词混合，在效果保持不变的情况下，性能提升最高可达40%。
- **词语关键度**：新增加词语关键度分类功能，在维持LAC词性标注结果下可以标注词语关键程度，
...
```text
【单样本】：key_result = [['LAC', '是', '个', '优秀', '的', '分词', '工具'], [3, 0, 0, 2, 0, 3, 1]]
【批量样本】：key_result = [
                    [['LAC', '是', '个', '优秀', '的', '分词', '工具'], [3, 0, 0, 2, 0, 3, 1]], 
                    [['百度', '是', '一家', '高科技', '公司'], [3, 0, 2, 3, 1]]
                ]
```
